...
void setup() {
  miFuente= loadFont("NotoMono.vlw");
  ...
  oscControl = new OscP5(this, 3366);
  ...
  cp5.addTextfield("TECNICA")
    .setPosition(posXCamara+338, posYCamara+500)
    .setSize (300, 40)
    .setFont(miFuente);
    ;
    push();
    
      cp5.addTextfield("TIPO DE MOVIMIENTO")
      
    .setPosition(posXCamara+338, posYCamara+600)
    .setSize (300, 40)
    .setFont(miFuente);
    ;
    pop();
  ...
  noStroke();
  //COLORES Y GROSOR DE LA LINEA
  grafico1.setColors("saturacion1", color(255, 0, 0));
  grafico1.setStrokeWeight(2.5);

  grafico2.setColors("saturacion2", color(255, 0, 0));
  grafico2.setStrokeWeight(2.5);

  grafico3.setColors("saturacion3", color(255, 0, 0));
  grafico3.setStrokeWeight(2.5);

  grafico4.setColors("saturacion4", color(255, 0, 0));
  grafico4.setStrokeWeight(2.5);
}
void draw() {
